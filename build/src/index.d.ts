...
export { GetBallotRequest, GetBallotResponse, } from './api/rpc/get-endorsement-ballot';
...
export { SubmitEntityRequest, SubmitEntityResponse, } from './api/rpc/submit-entity';
